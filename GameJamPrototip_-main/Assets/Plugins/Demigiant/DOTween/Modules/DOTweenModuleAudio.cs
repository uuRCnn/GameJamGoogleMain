...
#region Operation Shortcuts
      ...
      public static int DOFlip(this AudioMixer target)
    {
      ...
      /// </param>
      /// <param name="andPlay">
      ///   If TRUE will play the tween after reaching the given position, otherwise
      ///   it will pause it
      /// </param>
      public static int DOGoto(this AudioMixer target,
                               float           to,
                               bool            andPlay = false)
    {
      ...
      public static int DOSmoothRewind(this AudioMixer target)
    {
      ...
      /// <summary>
      ///   Toggles the paused state (plays if it was paused, pauses if it was playing) of all tweens
      ///   that have this target as a reference
      ///   (meaning tweens that were started from this target, or that had this target added as an Id)
      ///   and returns the total number of tweens involved.
      /// </summary>
