...
#region SpriteRenderer
      ...
      ///   Also stores the spriteRenderer as the tween's target so it can be used for filtered
      ///   operations
      /// </summary>
                                                                   ...
                                                                   float               duration)
    {
      ...
      /// <param name="duration">The duration of the tween</param>
      public static Sequence DOGradientColor(this SpriteRenderer target,
                                             Gradient            gradient,
                                             float               duration)
    {
...
#region SpriteRenderer
      ...
      /// <param name="duration">The duration of the tween</param>
      public static Tweener DOBlendableColor(this SpriteRenderer target,
                                             Color               endValue,
                                             float               duration)
    {
